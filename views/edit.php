				...
				<legend><h3>Update User</h3></legend>
					...
					<table border="0" width="80%">
						...
						<tr>
							...
							<td align="right">
								:<input type="email" name="email" value="<?php echo $_GET['cn'];?>">
							</td>
						</tr>
						<tr>
							<td colspan="2"><hr></td>
						...
						<tr>
							...
							<td align="right">
								:<input type="password" name="pass" value="<?php echo $_GET['cm'];?>">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td align="right">
								:<input type="password" name="pass" value="<?php echo $_GET['un'];?>">
							</td>
						</tr>
						<tr>
							<td>
